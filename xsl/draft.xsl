...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		...
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="120" height="120" viewBox="0 0 120 120" xml:space="preserve">
			...
			<text x="30" y="15" transform="rotate(45 30,15)" xsl:use-attribute-sets="__watermark.draft">
				<xsl:call-template name="getVariable">
					<xsl:with-param name="id" select="'Draft'"/>
				</xsl:call-template>
			</text>
			<text x="5" y="15" transform="rotate(45 5,15)" xsl:use-attribute-sets="__watermark.draft">
				<xsl:call-template name="getVariable">
